...
<p>
  <a
    href="/levi-braga-resume.pdf"
    download
    class="focus-outline bg-accent text-accent-foreground inline-block rounded px-4 py-2 font-medium no-underline"
  >
    Download PDF
  </a>
</p>
...
<p class="text-muted-foreground text-sm sm:hidden">
  The inline viewer is hidden on small screens because most mobile browsers
  cannot render it. Use the download button above.
</p>
